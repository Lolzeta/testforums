...
<div class="container">
    <div class="offset-3 col-6 pt-4 pb-4">
        ...
        <div class="form-group">
                ...
                <small id="usernameHelp" class="form-text text-muted">Usuario con el que esta registrado.</small>
            ...
            <div class="form-group">
                ...
                <small id="passwordHelp" class="form-text text-muted">Introduce la contraseña del usuario registrado.</small>
            ...
            <?php foreach ($errors['login'] as $error): ?>
                ...
                <?php endif; ?> 
            <button type="submit" name="login" class="btn btn-primary">Logearse</button>
        </form>
    </div>
</div>
<?php
