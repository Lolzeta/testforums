        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <?php if( !isset($_SESSION['usuario']) ): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link link-important" href="<?=BASE_URL?>register">Registrarse</a>
                    </li>
                <?php else: ?>
                    <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?=BASE_URL?>my_rooms"><i class="fas fa-list"></i> Mis Salas <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?=BASE_URL?>create_room"><i class="fas fa-plus"></i> Crear Sala</a>
                    </li>
                    </ul>
                    <ul class="navbar-nav ml-auto">
