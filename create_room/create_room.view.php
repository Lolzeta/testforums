    ...
    <div class="offset-3 col-6 pt-4 pb-4">
        ...
        <form action="" method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?=($errors['category'])?"is-invalid":""?>" id="category" name="category" aria-describedby="categoryHelp" placeholder="Introduce un nombre para la sala" value="<?=($category??'')?>">
